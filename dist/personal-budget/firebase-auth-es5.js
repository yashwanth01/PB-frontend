      ...
      (function () {
        ...
        */
        ...
        function ei(a, b, c, d, e) {
          ...
          try {
            hi(a), 0 < a.g && (a.u = ii(a.a), Uh(a.b, fi(a, "Will abort after " + a.g + "ms if incomplete, xhr2 " + a.u)), a.u ? (a.a.timeout = a.g, a.a.ontimeout = q(a.Ma, a)) : a.s = Dd(a.Ma, a.g, a)), Uh(a.b, fi(a, "Sending request")), a.i = !0, a.a.send(b), a.i = !1;
          } catch (g) {
        ...
        k.Ub = function () {
          this.xa || (this.N || this.i || this.f ? li(this) : this.Ic());
        };
        ...
        function li(a) {
          if (a.c && "undefined" != typeof ha) if (a.A[1] && 4 == mi(a) && 2 == ni(a)) Uh(a.b, fi(a, "Local request error detected and ignored"));else if (a.i && 4 == mi(a)) Dd(a.Ub, 0, a);else if (a.dispatchEvent("readystatechange"), 4 == mi(a)) {
        ...
        */
        ...
        function O(a, b, c) {
          ...
          return E(c).then(b.B).then(function () {
            ...
            return d ? Yi(a, a.i, b.endpoint, e, c, b.Gb, b.kb || !1) : Yi(a, a.h, b.endpoint, e, c, b.Gb, b.kb || !1);
          }).then(function (g) {
            f = g;
        ...
        k.Lb = function (a, b, c, d, e, f, g, h) {
          ...
          return this.a.then(function () {
            ...
            if (!g) {
              var p = ek(n.s, n.g, n.b, b, c, null, f, n.c, void 0, n.i, h, n.f);
              se(p, a);
            }
          }).o(function (p) {
        ...
        function dk(a) {
          a.l || (a.A = a.c ? Oe(a.c, Xj(a.b)) : null, a.l = new Ii(a.g, Ca(a.i), a.A), a.f && Pi(a.l, a.f));
          return a.l;
        }
        ...
        function xl(a, b, c, d, e) {
          ...
          f = vl(f);
          p.sessionId = f;
          var v = ek(a.m, a.i, a.l, b, c, null, d, a.v, p, a.u, e, a.s);
          ...
          function b(g) {
            ...
            yl(a).then(function (h) {
              ...
              if (h && g && g.url) {
                var p = null;
                n = xg(g.url);
                -1 != n.indexOf("/__/auth/callback") && (p = be(n), p = We(ae(p, "firebaseError") || null), p = (p = "object" === typeof p ? Aa(p) : null) ? new sh(h.c, h.b, null, null, p, null, h.S()) : new sh(h.c, h.b, n, h.f, null, null, h.S()));
                n = p || c;
              }
        ...
        function Em(a, b) {
          return Wi(a.c, b).then(function (c) {
        ...
        Am.prototype.getToken = function (a) {
          a = !!a;
          return this.b && !this.a ? F(new t("user-token-expired")) : a || !this.b || va() > Bm(this) - 3E4 ? this.a ? Em(this, {
        ...
        function Mm(a, b) {
          a.X = b;
          Ri(a.a, _firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].SDK_VERSION ? Oe(_firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].SDK_VERSION, a.X) : null);
        }
        ...
        function jn(a, b, c, d, e) {
          ...
          var f = ng(c.providerId),
              g = Qe(a.uid + ":::"),
              h = null;
          (!Te() || Ie()) && a.s && c.isOAuthProvider && (h = ek(a.s, a.l, a.m, b, c, null, g, _firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].SDK_VERSION || null, null, null, a.tenantId));
          var n = ze(h, f && f.ua, f && f.ta);
          d = d().then(function () {
            kn(a);
            if (!e) return a.I().then(function () {});
          }).then(function () {
            return Tl(a.i, n, b, c, g, !!h, a.tenantId);
          }).then(function () {
        ...
        function pn(a) {
          ...
          var b = {
            ...
            emulatorConfig: a.emulatorConfig
              ...
              c = {};
          if (a.stsTokenManager && a.stsTokenManager.accessToken) c[Dg] = a.stsTokenManager.accessToken, c.refreshToken = a.stsTokenManager.refreshToken || null;else return null;
          var d = new Im(b, c, a);
        ...
        k.Fc = function (a) {
          this.N.push(a);
          Ri(this.a, _firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].SDK_VERSION ? Oe(_firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].SDK_VERSION, this.N) : null);
        ...
        k.Wc = function (a) {
          ...
          var b = this,
              ...
              d = Qe(),
              e = null;
          (!Te() || Ie()) && S(this).options.authDomain && a.isOAuthProvider && (e = ek(S(this).options.authDomain, S(this).options.apiKey, S(this).name, "signInViaPopup", a, null, d, _firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].SDK_VERSION || null, null, null, this.S(), this.f));
        ...
        (function () {
          if ("undefined" !== typeof _firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"] && _firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].INTERNAL && _firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].INTERNAL.registerComponent) {
            ...
            _firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].registerVersion("@firebase/auth", "0.16.0");
